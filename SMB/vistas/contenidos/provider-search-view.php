...
<div class="full-box page-header">
    <h3 class="text-left text-uppercase">
        <?php echo $lc->enrutador("proveedor_search","encabezado",0); ?>
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs text-uppercase">
        ...
        <li><?php echo $lc->enrutador("proveedor_list","inactivo",0); ?></li>
        <li><?php echo $lc->enrutador("proveedor_search","activo",0); ?></li>
    </ul>	
</div>
<?php
...
<div class="container-fluid">
    <?php
        ...
        echo $ins_proveedor->paginador_proveedor_controlador($pagina[1],15,$pagina[0],$_SESSION['busqueda_proveedor']);
    ?>
</div>
<?php } ?>