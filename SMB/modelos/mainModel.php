	...
	class mainModel{
		...
		public function enrutador($clave,$tipo,$parametro){
			$rutas=[
				...
				"proveedor_search"=>[
					"vista"=>"provider-search",
					"icono"=>"",
					"nombre"=>"Buscar proveedor",
				],
				"proveedor_update"=>[
					"vista"=>"provider-update",
					"icono"=>"",
				...
				"cliente_list"=>[
					"vista"=>"client-list",
					"icono"=>"",
					"nombre"=>"Lista de beneficiarios",
				],
				"cliente_search"=>[
					"vista"=>"client-search",
					"icono"=>"",
					"nombre"=>"Buscar beneficiario",
				],
				"producto_new"=>[
					"vista"=>"product-ne",
					"icono"=>"",
					"nombre"=>"Prueba de fuerza",
				],
				"producto_list"=>[
					"vista"=>"product-lis",
					"icono"=>"",
				...
				"producto_expiration"=>[
					"vista"=>"product-expiratio",
					"icono"=>"",
					"nombre"=>"Osciloscopio",
				],
				"producto_minimum_stock"=>[
					"vista"=>"product-minimu",
					"icono"=>"",
					"nombre"=>"Medición mioeléctrica",
				],	
				"kardex_product"=>[
					"vista"=>"kardex-produc",
					"icono"=>"",
