<?php
	...
	class compraControlador extends mainModel{
        ...
        public function agregar_producto_compra_controlador(){

            /*== Recuperando codigo del producto ==*/
			$codigo=mainModel::limpiar_cadena($_POST['producto_codigo_kart']);
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="text-center" >
                            ...
                            <td>'.mainModel::enrutador("compra_detail","btn_info",$rows['compra_codigo']).'</td>
                        </tr>
                    ';
                    $contador++;
				}
